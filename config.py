...
with open('abi/zebraswap/classic_pool.json') as file:
    ZEBRASWAP_CLASSIC_POOL_ABI = json.load(file)

with open("abi/zebraswap/router.json", "r") as file:
    ZEBRASWAP_ROUTER_ABI = json.load(file)
    
with open('abi/zebraswap/classic_pool_data.json') as file:
    ZEBRASWAP_CLASSIC_POOL_DATA_ABI = json.load(file)
...
ZEBRASWAP_CONTRACTS = {
    ...
    "classic_pool": "0xa63eb44c67813cad20A9aE654641ddc918412941"
}
SCROLL_TOKENS = {
